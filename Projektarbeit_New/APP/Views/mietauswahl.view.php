    ...
    <div class="transbox">
      ...
      <form action='mietabschluss.php' method="POST" class="row">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 text-center my-3">
          ...
          Grössen: <?php echo $mietobjekt->KoerpergroesseVon . "-" . $mietobjekt->KoerpergroesseBis; ?> cm<br />
          Preis: CHF <?php echo number_format($mietobjekt->PreisProTag * $_SESSION['dauer'], 2, '.', '\'') ?><br />
